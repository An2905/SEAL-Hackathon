...
public class EventRepository {
  ...
  public List<TeamRegistration> findTeamRegistrationsByEventId(String eventId) {
    ...
    String sql =
        "SELECT tr.registration_id, t.team_id, t.team_name, tr.status, tr.github_team_id, tr.github_team_slug, tr.github_repo_id, tr.github_repo_url "
  ...
  public List<TeamRegistration> findAssignedTeamsInGroup(String groupId, String eventId) {
    List<TeamRegistration> registrations = new ArrayList<>();
    String sql =
        "SELECT tr.registration_id, gt.team_id, t.team_name, tr.status, tr.github_team_id, tr.github_team_slug, tr.github_repo_id, tr.github_repo_url "
            + "FROM group_teams gt "
  ...
  public List<TeamRegistration> findAvailableTeamsForRound(String eventId, String roundId) {
    List<TeamRegistration> registrations = new ArrayList<>();
    String sql =
        "SELECT tr.registration_id, tr.team_id, t.team_name, tr.status, tr.github_team_id, tr.github_team_slug, tr.github_repo_id, tr.github_repo_url "
