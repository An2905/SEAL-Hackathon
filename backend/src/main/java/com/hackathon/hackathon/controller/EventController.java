...
public class EventController {
  ...
  public ResponseEntity<EventUpdateResponse> updateEvent(
      @RequestHeader("Authorization") String authHeader, @RequestBody UpdateEventRequest request) {
  ...
  public ResponseEntity<EventAwardResponse> createAward(
      @RequestHeader("Authorization") String authHeader, @RequestBody CreateAwardRequest request) {
    return ResponseEntity.ok(eventService.createAward(authHeader, request));
  }

  @PutMapping("/awards")
  public ResponseEntity<EventAwardResponse> updateAward(
      @RequestHeader("Authorization") String authHeader, @RequestBody UpdateAwardRequest request) {
