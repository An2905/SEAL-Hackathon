...
public class AuthController {
  ...
  public String sendResetPasswordOtp(
      @RequestBody ResetPasswordOtpRequest request, HttpSession session) {
  ...
  public String verifyAndRegister(
      @RequestBody VerifyStudentRegisterRequest request, HttpSession session) {
