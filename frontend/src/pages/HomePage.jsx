...
export default function HomePage() {
  ...
  return (
    <>
      <HomeNavbar onOpenLogin={() => setModal('login')} onOpenRegister={() => setModal('register')} />
      ...
      <main>
        ...
        <section className='hero'>
          <div className='hero-grid'>
            <div className='hero-content'>
              ...
              <p className='lead'>
                Sân chơi học thuật dành cho sinh viên đam mê công nghệ — nơi bạn xây dựng các hệ thống AI RAG có khả
                năng truy xuất tri thức chuyên ngành và tạo ra giải pháp công nghệ thực tiễn.
              </p>
              ...
              {!isLoggedIn && (
                <div className='hero-cta'>
                  ...
                  <button className='btn btn-outline btn-lg' onClick={() => setModal('login')}>
                    Tôi đã có tài khoản
                  </button>
                </div>
              )}
        ...
        <section className='section' id='about'>
          <div className='section-head'>
            ...
            <p>Mùa hai của hành trình đào tạo và trải nghiệm AI thực chiến dành cho sinh viên Công nghệ thông tin.</p>
          </div>
        ...
        <section className='section' id='schedule'>
          <div className='section-head'>
            ...
            <p>3 mốc quan trọng bạn không thể bỏ lỡ — từ workshop đến đêm trao giải.</p>
          </div>
          ...
          <div className='schedule'>
            <div className='schedule-item'>
              ...
              <p>"Transforming Complex Data into Actionable Domain Insights" — nền tảng cho hành trình hackathon.</p>
            ...
            <div className='schedule-item'>
              ...
              <p>Lễ khai mạc chính thức, công bố bảng thi đấu và buổi gặp gỡ giữa các đội.</p>
            ...
            <div className='schedule-item'>
              ...
              <p>Ngày thi đấu chính thức, demo sản phẩm, chấm điểm và lễ trao giải.</p>
              <div className='meta'>Offline · FPT University HCM</div>
            </div>
          </div>
          ...
          <div className='location-card'>
            <div className='loc-info'>
              <div className='loc-text'>
                ...
                <span>Lô E2a-7, đường D1, Khu CNC, phường Tăng Nhơn Phú, TP.HCM</span>
              </div>
            </div>
          </div>
        </section>
